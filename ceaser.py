...
def ceaser_unshift(text, shift):
    return ceaser_shift(text, -shift)


def ceaser_brute_force(text):
    solutions = {}
...
def _grade_solution_no_spaces(text, word_list):
    grade = 0
...
def main():
    builtin_word_list()
    parser = argparse.ArgumentParser(description='Ceaser Cipher Solver')
